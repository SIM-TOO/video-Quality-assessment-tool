...
2. **품질 메트릭 비교 분석** - 두 비디오 파일 품질 비교 (PSNR, SSIM, VMAF)
3. **단일 비디오 품질 분석** - 하나의 비디오 파일 품질 분석
4. **DCI/OTT 표준 준수 검사** - 업계 표준 준수 여부 확인
5. **종합 품질 분석** - 모든 기능을 통합한 완전한 분석
6. **배치 처리** - 폴더 내 모든 비디오 파일 일괄 처리
7. **HTML 보고서 생성** - 기존 분석 결과를 HTML 보고서로 변환
...
```
기능을 선택하세요 (0-7): 5
분석할 비디오 파일 경로: C:\Videos\sample.mp4
다른 비디오와 비교하시겠습니까? (y/n): n
분석할 프레임 수 (기본값: 20): 30
```
...
```
기능을 선택하세요 (0-7): 2
참조 비디오 파일 경로: C:\Videos\original.mp4
비교할 비디오 파일 경로: C:\Videos\compressed.mp4
분석할 프레임 수 (기본값: 20): 50
레터박스 자동 제거 (y/n, 기본값: y): y
```
